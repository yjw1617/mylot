...
//#define GUI_NUMBYTES    (30*1024)		 //定义外部存储器大小
//#define GUI_BLOCKSUZE   (0X80)		//定义最小内存库操作大小
//char stmwin_ram[GUI_NUMBYTES]; //FSMC->SRAM存储器首地址


#define GUI_NUMBYTES    (512*1024)		 //定义外部存储器大小
#define GUI_BLOCKSUZE   (0X80)		//定义最小内存库操作大小
#define SRAM_BANK_ADDR  ((U32)0x68000000) //FSMC->SRAM存储器首地址
...
//	volatile U32* aMemory = (volatile U32*)(stmwin_ram);
